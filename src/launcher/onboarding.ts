...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  },
  {
    ...
    description:
      '단계를 해결하면 장치 창이 닫히고 큰 성공 화면이 나타납니다. 다음 단계 시작 버튼을 누르면 새 장치 창이 안전하게 열립니다. 시작하기 전에 브라우저 주소창 오른쪽 위의 팝업 차단 아이콘에서 이 사이트의 팝업 및 리디렉션을 항상 허용하세요.',
    lesson: '팝업 허용은 필수입니다. 막히면 R 키로 현재 단계를 초기화할 수 있습니다.'
  }
] as const;
